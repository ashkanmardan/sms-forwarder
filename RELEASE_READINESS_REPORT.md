...
- Device QA: maintainer confirmed successful testing of this final signed APK; screenshots are redacted in `docs/screenshots/`.
- SMS forwarding: confirmed by maintainer on a real Android phone.
